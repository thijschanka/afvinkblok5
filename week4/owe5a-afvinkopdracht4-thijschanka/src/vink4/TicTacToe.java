        ...
        for (int x = 0; x != 3; x++){
        	for (int y = 0; y != 3; y++){
        		if (buttonPressed == button[x][y]) {
        			...
        			JButton knop = button[x][y];
        			
        			if((player++)%2 != 0) {
        				knop.setIcon(kruisje);
        				messageLabel.setText("Rondje mag nu");
        			}
        			else {
        				knop.setIcon(rondje);
        				messageLabel.setText("Kruisje mag nu");
        			}
        			knop.setDisabledIcon(knop.getIcon());
        			knop.setEnabled(false);
        			who_won_whos_next_you_decide();        			
        		}
        	}
        }
    }
    
	public void who_won_whos_next_you_decide() {
		ImageIcon winner = leeg;
		if (button[0][0].getIcon() == button[0][1].getIcon() && button[0][0].getIcon() == button[0][2].getIcon())winner = (ImageIcon) button[0][0].getIcon();
		if (winner == leeg && button[0][0].getIcon() == button[1][1].getIcon() && button[0][0].getIcon() == button[2][2].getIcon())winner = (ImageIcon) button[0][0].getIcon();
		if (winner == leeg && button[0][0].getIcon() == button[1][0].getIcon() && button[0][0].getIcon() == button[2][0].getIcon())winner = (ImageIcon) button[0][0].getIcon();
		if (winner == leeg && button[0][1].getIcon() == button[1][1].getIcon() && button[0][1].getIcon() == button[2][1].getIcon())winner = (ImageIcon) button[0][1].getIcon();
		if (winner == leeg && button[1][0].getIcon() == button[1][1].getIcon() && button[1][0].getIcon() == button[1][2].getIcon())winner = (ImageIcon) button[1][0].getIcon();
		if (winner == leeg && button[2][2].getIcon() == button[2][0].getIcon() && button[2][2].getIcon() == button[2][1].getIcon())winner = (ImageIcon) button[2][2].getIcon();
		if (winner == leeg && button[2][2].getIcon() == button[0][2].getIcon() && button[2][2].getIcon() == button[1][2].getIcon())winner = (ImageIcon) button[2][2].getIcon();
		if (winner == leeg && button[0][2].getIcon() == button[1][1].getIcon() && button[0][2].getIcon() == button[2][0].getIcon())winner = (ImageIcon) button[0][2].getIcon();
		if (winner != leeg) {
			for (int x = 0; x != 3; x++){
	        	for (int y = 0; y != 3; y++){
	        ...
	        if (winner == rondje) JOptionPane.showMessageDialog(null, "rondje wint");
	        if (winner == kruisje) JOptionPane.showMessageDialog(null, "kruisje wint");
		}else if(player == 9)JOptionPane.showMessageDialog(null, "gelijk spel");
	}
}
